...
import com.playtwowin.model.FontInfo;
...
public class PDFService {
	...
	public PDFService(InputStream inputDocument) throws IOException {
	...
	public void addText(int pageIndex, List<TextLine> lines) throws IOException {
		...
		for (TextLine cline : lines) {
			FontInfo fontInfo = calculateFontSize(cline.text, (float) cline.width * width,
					(float) cline.height * height);

			// System.out.println("FontSize: " + fontInfo.fontSize + " => for text: " +
			// cline.text);
